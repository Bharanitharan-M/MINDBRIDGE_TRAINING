    ...
    return(
        <form className="form_layout" key={"form"}>
            {props.filed_attribute.map((element)=>
                <Input id={element.id} lable_name={element.label_name} type={element.type} placeholder={element.placeholder} change={props.change} value={props.value} err={props.err} />
            )}
